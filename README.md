...
**MemosM** is an Android client designed to target the latest stable release of [Memos](https://usememos.com/) (currently v0.26.0). 
...
- User
  - Auth  
    - [x] Login with token
    - [x] Login with password (no refresh) 
  - User info
    - [x] View user info
    - [x] Edit user info
    - [x] Activities
